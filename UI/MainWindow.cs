namespace DIA_GestionFlota
{
    ...
    class MainWindow : Form
    {
        public MainWindow()
        {
            ...
            Flota flota1 = new Flota(1.5, "AAA9999", "Mudanza", "opel", "modelo", 20.0, new DateTime(2000, 12, 12), new DateTime(1999, 12, 12), new List<string>());
            Flota flota2 = new Flota(2, "AAA6666", "Transporte de mercancías", "opel2", "modelo",20.0, new DateTime(2013, 11, 10), new DateTime(2000, 10, 11), new List<string>());
            ...
            //this.MainWindowView.consultarFlota.Click += (sender, e) => this.consultarFlota();
        ...
        //public DialogoConsultar dialogoConsultar { get; set; }
        //Busqueda
